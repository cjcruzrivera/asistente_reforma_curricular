...
from .views import IndicadorCreateView, IndicadorUpdateView, eliminar, view_one, actividad, max_Porcentaje
...
urlpatterns = [
    ...
    url(r'^max/(?P<pk>\d+)/$', login_required(max_Porcentaje), name='max_Porcentaje'),
